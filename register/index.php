...
if(isset($_POST["submit"])){
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM user WHERE phone_number ='$phone_number'");
    if(mysqli_num_rows($duplicate) >0){

        TextNode("error", "Error: phone number has already been registered with another account!!");
    }

    else{
        if($password == $confirmpassword){
            $query = "INSERT INTO user (first_name,	last_name, phone_number, password ) VALUES ('$first_name', '$last_name', '$phone_number', '$password')";
		...
		TextNode("error", "Error: passwords do not match!!");
    };
...
function TextNode($classname, $msg){
    $element ="<h6 class='$classname  absolute bottom-0 w-64 m-8 p-8 h-16 bg-red-400 shadow shadow-lg font-bold text-white rounded'>$msg</h6>";
    echo $element;
}
...
<head>
	...
	<link rel= "stylesheet" href="../css/tailwind.css">
        ...
        <script src='../js/jquery/jquery1.js'></script>
<!--===============================================================================================-->
...
<nav class='w-screen p-4 inline-flex shadow' style='background: #f2fbfe'>
    ...
    <script>
         $('.form').click(function(event){
                ...
                if(fName,lName,pNumber,password,password2){
                    if(Validator.isValidContact(pNumber) && Validator.isValidPassword(password) && Validator.isValidPassword(password2) && Validator.isValidName(fName) && Validator.isValidName(lName)){
                        console.log(2)
                        return true;
                    }
                }
