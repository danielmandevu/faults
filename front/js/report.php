...
<section class="register-photo">
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group"> <select class="form-control" type="Role" name="option" id="option"  >
            ...
            <div class="form-group"><input class="form-control" type="text" name="description" id ="description" placeholder="Describe the area. ie. landmarks close to it"></div>
